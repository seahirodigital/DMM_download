...
async function loadConfig() {
  ...
  return {
    ...
    affiliate: {
      ...
      itemListAffiliateId: process.env.DMM_AFFILIATE_ID || merged.affiliate.itemListAffiliateId || '',
...
function getPublicConfig(config) {
  ...
  return {
    ...
    affiliate: {
      hasItemListCredentials: Boolean(config.affiliate.apiId && config.affiliate.itemListAffiliateId),
